...
# python3 script saida_test.txt resultados.csv
...
writer.writerow(['adj','nsents','avg_tot','nattr','attr','suj_masc','suj_fem','suj_sing','sux_pl','curta','longa'])
...
ind_d1_dnum0=np.where((label_d==1)&(label_dnum==0))[0]
ind_d1_dnum1=np.where((label_d==1)&(label_dnum==1))[0]
...
file=open(sys.argv[2] + "_attr.csv", "w")
writer=csv.writer(file)
writer.writerow(['adj','nsents','nattr_suj_sing','nattr_suj_pl','attr_suj_sing','attr_suj_pl','nattr_suj_masc','nattr_suj_fem','attr_suj_masc','attr_suj_fem','attr_dist_sing','attr_dist_pl','nattr_curta','nattr_longa','attr_curta','attr_longa'])
...
for i in np.arange(nadx):
    ...
    ind0=ind_d1_dnum0[np.where((m*i<=ind_d1_dnum0)&(ind_d1_dnum0<m*(i+1)))]
    ind1=ind_d1_dnum1[np.where((m*i<=ind_d1_dnum1)&(ind_d1_dnum1<m*(i+1)))]
    media_d1_dnum0.append(np.mean(resultados[ind0]))
    media_d1_dnum1.append(np.mean(resultados[ind1]))
    ...
    writer.writerow([adx[i],m,media_d0_snum0[i],media_d0_snum1[i],media_d1_snum0[i],media_d1_snum1[i],media_d0_sgen0[i],media_d0_sgen1[i],media_d1_sgen0[i],media_d1_sgen1[i],media_d1_dnum0[i],media_d1_dnum1[i],media_d0_long0[i],media_d0_long1[i],media_d1_long0[i],media_d1_long1[i]])

writer.writerow(['avg',m,np.mean(media_d0_snum0),np.mean(media_d0_snum1),np.mean(media_d1_snum0),np.mean(media_d1_snum1),np.mean(media_d0_sgen0),np.mean(media_d0_sgen1),np.mean(media_d1_sgen0),np.mean(media_d1_sgen1),np.mean(media_d1_dnum0),np.mean(media_d1_dnum1),np.mean(media_d0_long0),np.mean(media_d0_long1),np.mean(media_d1_long0),np.mean(media_d1_long1)])
file.close()
...
writer=csv.writer(file)
writer.writerow(['adj','nsents','curta_suj_sing','curta_suj_pl','longa_suj_sing','longa_suj_pl','curta_suj_masc','curta_suj_fem','longa_suj_masc','longa_suj_fem','curta_nattr','curta_attr','longa_nattr','longa_attr'])
